...
* @access   public
*/
class MondialRelayTracking extends nusoap_base  {
	...
	* @access   public
	*/
	function MondialRelayTracking($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 30, $portName = ''){
		parent::nusoap_base();
	...
	*/
	...
	";
		...
		$evalStr = 'class nusoap_proxy_'.$r.' extends MondialRelayTracking {
	'.$evalStr.'
}';
		return $evalStr;
	}
...
if (!extension_loaded('soap')) {
	 ...
	 */
	class soapclient extends MondialRelayTracking {
	}
}
?>