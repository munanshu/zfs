<?php
class Application_Model_RswisspostLabel extends Zend_custom{
	  public function CreateRswisspostLabel($shipmentObj,$newbarcode=true){  
	  	 $checkdigit = $this->checkdigit_Rswiss($shipmentObj->RecordData[TRACENR]);
		 $barcode_suffix = 'CH';
		 ...
		 $this->generateBarcode($shipmentObj);//echo "<pre>";print_r($shipmentObj->RecordData);die;
	  }
	/**
	 * @Function : GenMOD11()
	 * @Description : this function assemble generate Checkdigit
     */
	public function checkdigit_Rswiss($base_val)
	{
	...
	public function generateBarcode($shipmentObj){
		...
		$IMAGE_NAME_S = 'Regi_'.$shipmentObj->RecordData[TRACENR].'.png';
